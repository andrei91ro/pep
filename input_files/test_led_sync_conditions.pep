num_ps = {
    ...
    m3 = {
        ...
        pr = { 4 * ( ((1) * 0) + ((1) * 1) + ((1) * 0) ) -> 1|rez3_1 + 1|rez3_2};
        var0 = (0, 0);
    };

    m4 = {
        var = {rez4_1, rez4_2, prox0_1, prox1_1, prox6_1, prox7_1}; # variables used in the production function
        pr = { (5 + 1 * ((prox0_1 + prox1_1) - (prox7_1 + prox6_1))) -> 1|rez4_1 + 1|rez4_2};
        var0 = (0, 0, 1, 2, 3, 4);
    };
}
